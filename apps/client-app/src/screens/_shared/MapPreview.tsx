...
/**
 * Mock xarita — haqiqiy xarita kutubxonasi ulanmagan, shuning uchun ko'cha
 * to'ri CSS bilan chiziladi. Yangi rang kiritilmaydi: faqat `surface-sunken`,
...
export interface MapPreviewProps {
  /** To'liq ekran (09) yoki karta ichidagi preview (10, 11, 23). */
  size?: 'preview' | 'full';
  /** 09-ekranda xarita yuklanayotganda yoki ruxsat yo'q bo'lganda pin chizilmaydi. */
  showPin?: boolean;
  className?: string;
}
...
/** Pin uchi xarita markazida turadi, shakli tepaga qarab o'sadi. */
...
export function MapPreview({ size = 'preview', showPin = true, className }: MapPreviewProps) {
  ...
  return (
    ...
    >
      ...
      {/* Asosiy ko'chalar — to'r bir tekis panjara bo'lib qolmasligi uchun. */}
